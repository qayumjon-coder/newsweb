  ...
  return (
    <>
        ...
        <div className="w-360 h-150 relative">
          ...
          <div className="flex w-full justify-center items-center">
            <div className="absolute  mb-4 z-2 top-[50%] font-satisfy">
              <p className="font-satisfy tracking-wider text-center text-lg -mt-4 mb-4">Blogdagi so'ngi yangiliklar</p>
      ...
      <section className="w-full flex justify-center relative">
        ...
        <div className="w-360 flex flex-col items-center pt-30 h-screen gap-10">

          <h2 className="text-5xl text-center w-full font-eater font-bold tracking-[30px] rotate-x-80 hover:rotate-x-0 transition text-shadow-md text-shadow-black/50">Latest news</h2>
